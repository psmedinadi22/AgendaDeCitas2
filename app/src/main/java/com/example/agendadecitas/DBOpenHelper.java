...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_EVETS_TABLE = "create table "+DBStructure.EVENT_TABLE_NAME+"(ID INTEGER PRIMARY KEY AUTOINCREMENT, "
